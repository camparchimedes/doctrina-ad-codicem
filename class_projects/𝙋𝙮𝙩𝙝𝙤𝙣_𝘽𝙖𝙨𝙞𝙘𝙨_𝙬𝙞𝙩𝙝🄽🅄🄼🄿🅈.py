...
### Exercise 1
Set test to `"Hello Deep learning!"` in the cell below to print "Hello World" and run the two cells below.
"""
...
<img src="https://github.com/OpenBanboo/Deep-Learning-Specialization/blob/main/Course1-Neural-Networks-and-Deep-Learning/Assignments/Week%202/W2A1_Python_Basics_with_Numpy/images/image2vector_kiank.png?raw=1" style="width:500px;height:300;">
